...
<link rel="shortcut icon"
	href="/teen/resources/images/icon/icon_favicon.ico" type="image/x-icon">
<!-- favicon -->
...
<link rel="stylesheet" type="text/css"
	href="/teen/resources/css/myPage.css">
</head>
<body>
	<!-- Header -->
	...
	<div id="contents">
		...
		<div id="contents_detail">
			<div id="contents_wrap">
								...
								<div class="profile">
									<div class="member_info">
										...
										<div class="info_box">
											...
											${board.member_nick}
											<p>
												<b>${board.member_nick}</b>님을 팔로우 합니다.<br> 팔로우한 날짜 :
												<fmt:formatDate value="${board.follow_date}"
													pattern="yyyy.MM.dd" />
											</p>
										</div>
										<button class="btn_com btn_mod_profile"
											onclick="location.href='/teen/follow/followList?member_no=${board.member_no }';">게시글
											보러가기</button>
										<button class="btn_com btn_mod_member"
											onclick="deleteFollow(${board.member_no })">팔로우
											취소하기</button>
									</div>
								</div>
							</c:forEach>
				...
				<!-- Member Info -->
				<div id="member_info">
					<a href="/teen/board/boardWrite" class="btn_com btn_main">게시글
						작성</a>
	...
	<script type="text/javascript"
		src="/teen/resources/js/member/myPage/myFollow.js"></script>
	<script type="text/javascript">
