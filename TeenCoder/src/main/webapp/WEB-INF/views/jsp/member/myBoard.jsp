				...
				<div id="board_list">
					...
					<div id="board_list_title">
						...
						<ul id="board_list_menu" class="side_menu">
							<li><a onclick="boardSearchRecent()"
								style="cursor: pointer;"><input type="hidden" id="recent"
									value="recent">최신순</a></li>
							<li><a onclick="boardSearchView()" style="cursor: pointer;"><input
									type="hidden" id="view" value="view">조회순</a></li>
							<li><a onclick="boardSearchRecommend()"
								style="cursor: pointer;"><input type="hidden" id="recommend"
									value="recommend">추천순</a></li>
							<li><a onclick="boardSearchComment()"
								style="cursor: pointer;"><input type="hidden" id="comment"
									value="comment">댓글순</a></li>
						</ul>
					</div>
					<!-- Search -->
								...
								<div class="row_title">
									<h3>
										<a href="/teen/resources/jsp/board/boardDetail.jsp"> <span
											class="tag_hit">[추천]</span> ${board.board_title} <!-- <img src="../resources/images/icon/icon_image.svg" class="i_image">  -->
