...
public List<Map<String, Object>> parseInsertProFileInfo(MemberModel memberModel, MultipartHttpServletRequest mpRequest) throws Exception{
	...
	public List<Map<String, Object>> parseUpdateCommentFileInfo(CommentModel commentModel, String[] files,String[] fileNames, MultipartHttpServletRequest mpRequest) throws Exception {
